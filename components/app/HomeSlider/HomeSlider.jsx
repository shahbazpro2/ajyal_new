...
class HomeSlider extends React.Component {
  ...
  changeImageHandler = (event) => {
    ...
    const prevUrl = this.props.responsive
      ? `${process.env.NEXT_PUBLIC_Slider_PREFIX}/${this.props.slider[prevIndex]?.responsiveImageUrl}`
      : `${process.env.NEXT_PUBLIC_Slider_PREFIX}/${this.props.slider[prevIndex]?.imageUrl}`;

    const nextUrl = this.props.responsive
      ? `${process.env.NEXT_PUBLIC_Slider_PREFIX}/${this.props.slider[nextIndex]?.responsiveImageUrl}`
  ...
  render() {
    const prevUrl = this.props.responsive
      ? `${process.env.NEXT_PUBLIC_Slider_PREFIX}/${
          this.props.slider[this.props.slider?.length - 1]?.responsiveImageUrl
        }`
      : `${process.env.NEXT_PUBLIC_Slider_PREFIX}/${
    ...
    const nextUrl = this.props.responsive
      ? `${process.env.NEXT_PUBLIC_Slider_PREFIX}/${this.props.slider[1]?.responsiveImageUrl}`
      : `${process.env.NEXT_PUBLIC_Slider_PREFIX}/${this.props.slider[1]?.imageUrl}`;
